/* Manipular matriz via objeto; 
   ...
   Versão: v1.0;
*/
// Criando um Objeto para manipular a matriz dentro do JS
// Criar uma função para o Objeto - matrizGrupo
// Esta função só será ativa quando passar as instâncias:
// codigo | nome | dataNascimento
function matrizGrupo(codigo,nome,dataNascimento){
    // O objeto irá ser ele mesmo "this" + a instância e recebe a variável
    this.codigo = codigo;
    this.nome = nome;
    this.dataNascimento = dataNascimento;
}
// Criar a matriz de manipulação "dados" e a variável de controle de linha "i"
let dados = new Array(); // let dados = [];
let i = 0;
// Criar as variáveis de entrada
...
do{
    ...
    // Incremento de 1 na variável de controle "i"
    i++
...
//Criar variável para pegar a quantidade de linhas da matriz "dados"
let j = dados.length;
...
function exibaDados(){
    ...
    for(i=0;i<j;i++){
        ...
        //Outra forma de atribuir o valor dele mesmo + o próximo
